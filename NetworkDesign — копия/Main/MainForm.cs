...
namespace NetworkDesign
{
    public partial class MainForm : Form
    {
        ...
        public List<NEButton> neButtons = new List<NEButton>();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ToolStripButton6_Click_1(object sender, EventArgs e) => MyMap.SetInstrument(4);
        /// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void NEClick(object sender, EventArgs e) => MyMap.SetInstrument(8);
        /// <summary>
